...
class Ui_Proyecto1(object):
    def setupUi(self, Proyecto1):
        ...
        self.lblSaludo.setGeometry(QtCore.QRect(450, 120, 171, 31))
        font = QtGui.QFont()
        ...
        self.btnAceptar.setGeometry(QtCore.QRect(530, 310, 131, 51))
        ...
        self.lblDNI.setGeometry(QtCore.QRect(20, 140, 47, 13))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.lblApellidos.setGeometry(QtCore.QRect(20, 170, 91, 16))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.lblNombre.setGeometry(QtCore.QRect(360, 170, 71, 16))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.btnAceptar_2.setGeometry(QtCore.QRect(220, 310, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        ...
        self.btnSalir.setGeometry(QtCore.QRect(340, 310, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        ...
        self.lblSexo.setGeometry(QtCore.QRect(10, 250, 91, 16))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.rbtFemenino.setGeometry(QtCore.QRect(90, 250, 91, 17))
        font = QtGui.QFont()
        ...
        self.rbtMasculino.setGeometry(QtCore.QRect(190, 250, 91, 17))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.lblSexo_2.setGeometry(QtCore.QRect(280, 250, 151, 20))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.chkEfectivo.setGeometry(QtCore.QRect(440, 250, 81, 17))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.chkTarjeta.setGeometry(QtCore.QRect(520, 250, 81, 17))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.chkTarjeta.setFont(font)
        self.chkTarjeta.setObjectName("chkTarjeta")
        self.chkTransfer = QtWidgets.QCheckBox(self.centralwidget)
        self.chkTransfer.setGeometry(QtCore.QRect(600, 250, 81, 17))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.lblDireccion.setGeometry(QtCore.QRect(20, 210, 91, 16))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.ltDireccion = QtWidgets.QLineEdit(self.centralwidget)
        self.ltDireccion.setGeometry(QtCore.QRect(110, 210, 191, 20))
        self.ltDireccion.setObjectName("ltDireccion")
        self.lblNombre_2 = QtWidgets.QLabel(self.centralwidget)
        self.lblNombre_2.setGeometry(QtCore.QRect(350, 210, 81, 16))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.cbProvincia.setGeometry(QtCore.QRect(440, 210, 191, 22))
